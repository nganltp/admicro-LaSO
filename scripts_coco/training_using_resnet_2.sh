...
python train_setops_stripped.py --inception_transform_input=False --resume_path=$LASO_MODEL/resnet_base_model_only_2  --init_inception=False --sets_basic_block_name=SetopResBasicBlock --sets_block_name=SetopResBlock_v1 --sets_network_name=SetOpsResModule --ops_latent_dim=8092 --ops_layer_num=2 --base_network_name=resnet50 --crop_size=224 --epochs=50 --train_base=False --coco_path=$COCO_PATH --results_path=$RESULT_PATH
